    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section id="home" className="mb-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              This is a beautiful HTML structure built with React JS
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-200 rounded-lg p-8 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600">Placeholder for image</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Our Features</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-12 h-12 bg-green-600 rounded-lg mb-4 flex items-center justify-center">
                <span className="text-white font-bold">✓</span>
              </div>
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Feature One</h4>
              <p className="text-gray-600">
                This is a description of the first feature. It explains what this feature does.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Feature Two</h4>
              <p className="text-gray-600">
                This is a description of the second feature. It explains what this feature does.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Feature Three</h4>
              <p className="text-gray-600">
                This is a description of the third feature. It explains what this feature does.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Table Section */}
        <section className="mb-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Data Table</h3>
