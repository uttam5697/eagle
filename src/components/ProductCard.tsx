...
const ProductCard: React.FC<ProductCardProps> = ({ imageUrl, title, price }) => {
    ...
    return (
        <div className="group max-w-sm  rounded-2xl bg-white p-2 shadow-sm transition-transform duration-300 hover:shadow-md">
            <div className="relative overflow-hidden rounded-xl">
                ...
                >
                    {liked ? (
                        ...
                        <HeartOutline size={18} className="text-black" />
                    )}
                </button>
            </div>
