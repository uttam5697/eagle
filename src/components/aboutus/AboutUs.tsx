            ...
            <div className="container relative z-10">
              <div className="mt-[191px]">
                <div className="max-w-[950px]">
                  ...
                  <div
                    className="text-white italic -tracking-[0.48px] 2xl:text-[48px] xl:text-[38px] lg:text-[28px] md:text-[24px] text-[20px] xl:leading-none leading-normal font-playfairDisplay"
                    data-swiper-parallax="-1000"
                  >
      ...
      <section className="xl:mb-[100px] lg:mb-[80px] md:mb-[60px] mb-[40px]">
        <div className="container">
            <div className="xl:mb-[50px] lg:mb-[40px] md:mb-[30px] mb-[20px]">
                ...
                <h1 className="text-primary italic 2xl:text-[48px] xl:text-[38px] lg:text-[28px] md:text-[24px] text-[20px] leading-normal font-playfairDisplay -mt-3">{aboutdata?.sub_title}</h1>
            </div>
